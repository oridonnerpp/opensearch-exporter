...
# OpenSearch Client
global awsauth, session, credentials, client, query, opensearch_index, opensearch_host, opensearch_port
...
print(f"============================== Initial Access Key: {credentials.access_key} ================================")
...
if __name__ == '__main__':
    ...
    scheduler.add_job(refresh_aws_credentials, 'interval', minutes=50)
