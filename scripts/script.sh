...
sudo docker build -t fetch:1.3.3  . 
sudo docker tag fetch:1.3.3  226228012207.dkr.ecr.us-east-1.amazonaws.com/opensearch-exporter:1.3.3
sudo docker tag fetch:1.3.3  226228012207.dkr.ecr.us-east-1.amazonaws.com/opensearch-exporter:latest

# login to testing account in order to push the image
...
sudo docker push 226228012207.dkr.ecr.us-east-1.amazonaws.com/opensearch-exporter:1.3.3
